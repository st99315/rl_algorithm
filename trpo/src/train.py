...
def run_policy(env, policy, scaler, logger, episodes, display):
    ...
    for e in range(episodes):
        observes, actions, rewards, unscaled_obs = run_episode(env, policy, scaler, display)
...
def main(env_name, num_episodes, gamma, lam, kl_targ, batch_size, hid1_mult, policy_logvar, display, load, directory, load_episodes):
    ...
    # init env, and get dims of obs and act
